package net.moddingplayground.toymaker.api.generator.loot;
...
import net.moddingplayground.toymaker.impl.mixin.BlockLootTableGeneratorAccessor;
import net.moddingplayground.toymaker.impl.mixin.BlockLootTableGeneratorInvoker;
